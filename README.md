...
![Segment breakdown page](screenshots/page2_segment_breakdown.png)
...
![Finance vs national and demographics page](screenshots/page3_finance_vs_national.png)
Dual-axis comparison against national employment, plus education-level and
nationality mix within the sector over time.

### Page 4 - Data Notes
![Data notes page](screenshots/page4_data_notes.png)
